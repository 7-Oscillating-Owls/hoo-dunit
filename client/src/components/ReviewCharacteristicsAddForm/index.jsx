  ...
  characteristicNames.forEach((name, index) => {
    ...
    if (name === 'Length') {
      lengthRender = (
        ...
        >
          <h5>Length: </h5>
          <input type="radio" id="productLength1" name="Length" value="1" />
          <label htmlFor="productLength1"> 1 - Runs short </label>
          <input type="radio" id="productLength2" name="Length" value="2" />
          <label htmlFor="productLength2"> 2 - Runs slightly short </label>
          <input type="radio" id="productLength3" name="Length" value="3" />
          <label htmlFor="productLength3"> 3 - Perfect </label>
          <input type="radio" id="productLength4" name="Length" value="4" />
          <label htmlFor="productLength4"> 4 - Runs slightly long </label>
          <input type="radio" id="productLength5" name="Length" value="5" />
